...
describe('app/containers/HomePage/HomePageNoAddon', () => {
  let props, subject;
  beforeEach(() => {
    props = {
      experiments: [],
  ...
  it('should render default content with experiments loaded', () => {
    ...
    subject.setProps({ experiments });
    expect(findLocalizedById(subject, 'landingIntroOne')).to.have.property(
      'length',
      1
    );
  ...
  it('should not display completed experiments', () => {
    const experiments = [
      { title: 'foo' },
      { title: 'bar', completed: '2016-10-01' }
    ];
    subject.setProps({ experiments });
...
describe('app/containers/HomePage/HomePageWithAddon', () => {
  let props, subject;
  beforeEach(() => {
    props = {
      ...
      majorNewsUpdates: [
        {
          ...
          image:
            'http://www.revelinnewyork.com/sites/default/files/RatMay8-21%2C1970_jpg.jpg',
        ...
        },
        {
          ...
          image:
            'http://www.revelinnewyork.com/sites/default/files/RatMay8-21%2C1970_jpg.jpg',
          content:
            'Min Vid 1.1.0 just shipped with enhanced browser support and a few other improvements as well.'
        },
        {
          experimentSlug: 'min-vid',
          slug: 'min-vid-update-3',
          title:
            'Another update, should be shown 1st in the carousel since it is fresher',
          link: 'https://medium.com/firefox-test-pilot',
          major: true,
  ...
  it('should show news update dialog if valid news updates are available', () => {
    subject = render(
      <HomePageWithAddon {...props} getExperimentLastSeen={() => {}} />
    );
