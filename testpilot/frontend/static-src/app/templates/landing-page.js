  ...
  <div class="page">
    <section class="main-content" data-hook="landing-page">
      ...
      {{^loggedIn}}
        ...
        <h1 data-l10n-id="landingWelcome">Welcome to Test Pilot</h1>
        ...
        <div id="cta-layout-wrapper">
          <div class="cta-layout">
            ...
            <p data-l10n-id="landingCtaLegal" class="cta-legal">By proceeding, you agree to the <a href="https://www.mozilla.org/about/legal/terms/services/">Terms of Service</a> and <a href="https://www.mozilla.org/privacy/firefox-cloud/">Privacy Notice</a> of Test Pilot.</p>
          </div>
          <div class="town">
            <div id="beta-notice-modal" class="hidden">
              <span data-l10n-id="landingBetaNotice">We're still building Test Pilot! Sign up now and we'll let you know when it's ready to go!</span>
      ...
      {{#loggedIn}}
        <div class="firefox-logo"></div>
        <h2 data-l10n-id="landingInstallHeader">Install the Test Pilot Add-on <br> and you're good to go!</h2>
        <div id="cta-layout-wrapper">
          <div class="cta-layout">
