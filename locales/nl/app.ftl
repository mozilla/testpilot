...
mobileDialogAndroidButton = De Android-app downloaden
mobileDialogIOSButton = De iOS-app downloaden
...
eolMessageFive =
    Dit
    <a data-l10n-name="blogPostLink">blogbericht</a>
    geeft meer informatie over waarom we met { -product } stoppen, en wat de toekomst in petto heeft.
eolMessageClose = Bedankt voor het vliegen,
eolMessageSignature = Het Test Pilot-team
