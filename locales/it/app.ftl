...
onboardingMessage = Abbiamo aggiunto un’icona alla barra degli strumenti. In questo modo sarà semplice facile trovare Test Pilot.
errorHeading = Oops.
errorMessage = Sembra che si sia rotto qualcosa.<br> Riprova più tardi.
notFoundHeader = Quattro zero quattro
emailOptInDialogTitle = Benvenuto in Test Pilot
emailOptInMessage = Scopri nuovi esperimenti e i risultati degli esperimenti che hai provato personalmente.
emailValidationError = Inserire un indirizzo email valido.

# LOCALIZATION NOTE: The ':)' characters in the emailOptInInput placeholder are a smiley face emoticon.
emailOptInInput = 
  [html/placeholder] l’email va qui :)
...
experimentListPageSubHeader = Scegli la funzione che ti interessa provare.<br> Torna a trovarci per scoprire altri esperimenti.
...
experimentPreFeedbackLinkCopy = Dacci la tua opinione a proposito di { $title }
...
retirePageHeadline = Grazie per aver volato con noi!
...
experimentPrivacyNotice = Qui puoi scoprire ulteriori informazioni sulla raccolta dati in { $title }.
