...
landingIntroTwo = Dicci cosa ne pensi.
landingIntroThree = Contribuisci al futuro di Firefox.
landingLegalNoticeWithLinks = Procedendo accetti i <terms-link>termini d’uso</terms-link> e l’<privacy-link>informativa sulla privacy</privacy-link> di Test Pilot.
landingMoreExperimentsButton = Altri esperimenti
...
oneClickInstallMinorCta = Installa Test Pilot e
...
landingCardThree = Di' cosa ne pensi
...
mobileDialogAndroidButton = Scarica l’app per Android
mobileDialogIOSButton = Scarica l’app per iOS
...
mobileDialogButtonSuccess = Grazie.
mobileDialogSuccessMain = Link di download inviato.
mobileDialogSuccessSecondarySMS = Controlla le email o i messaggi sul tuo dispositivo.
...
mobileDialogNoticeSMSWithLink = Il servizio SMS è disponibile solo in alcune nazioni. Potrebbero essere applicati costi aggiuntivi per SMS o traffico dati. Il destinatario dell’email o del messaggio devono aver fornito il proprio consenso. <a>Ulteriori informazioni</a>.

## Featured experiment.

moreDetail = Visualizza dettagli
...
experimentListHeaderWithFeatured = Prova tutti i nostri esperimenti
...
experimentManuallyDisabled = { $title } è disattivato in Gestione componenti aggiuntivi
...
startedDate = Data di inizio esperimento: <b>{ DATETIME($startedDate) }</b>
...
experimentPlatformAddon = Esperimento Firefox
experimentPlatformAndroid = Esperimento Android
experimentPlatformIos = Esperimento iOS
experimentPlatformWeb = Experimento web
experimentPlatformAddonWeb = Esperimento Firefox/Web
experimentPlatformAddonAndroid = Esperimento Firefox/Android
experimentPlatformAddonIos = Esperimento Firefox/iOS
experimentPlatformAddonAndroidIos = Esperimento Firefox/iOS/Android
experimentPlatformAddonAndroidWeb = Esperimento Firefox/Web/Android
experimentPlatformAddonAndroidIosWeb = Esperimento Firefox/Web/Android/iOS
experimentPlatformAndroidWeb = Esperimento Web/Android
experimentPlatformAndroidIos = Esperimento Android/iOS
...
versionChangeNotice = { $experiment_title } non è compatibile con questa versione di Firefox.
versionChangeNoticeLink = Scarica l’ultima versione di Firefox.
...
eolTitleMessage = { $title } si concluderà il { DATETIME($completedDate) }
...
completedDate = Data di fine esperimento: <b>{ DATETIME($completedDate) }</b>
