...
minvidIntroduction = <p>Adori guardare video? Vorresti continuare a lavorare mentre guardi i video? Prova Min Vid. È un po' come un quadro dentro un altro quadro, con il tuo video circondato dal Web.</p><ul> <li><strong>Fai clic e inizia:</strong> apri la cornice di Min Vid per continuare a riprodurre i video in primo piano mentre navighi.</li> <li><strong>Spostalo dove ti è più comodo:</strong> Min Vid ti permette di trascinare la cornice in qualunque punto del tuo schermo.</li> <li><strong>Tutti i controlli nel posto giusto:</strong> Min Vid include controlli per interrompere o avviare la riproduzione, chiudere, trascinare o minimizzare il video, regolare i volume direttamente nella cornice.</li></ul>
...
pageshotMeasurements = <p>In aggiunta ai <a href="/privacy">dati</a> raccolti in tutti gli esperimenti Test Pilot, ecco alcune informazioni utili su quello che accade quando utilizzi Page Shot:</p><ul> <li>Salviamo le schermate sui server Mozilla e abbiamo accesso a queste immagini. Tuttavia accederemo alle schermate solo quando richiesto per il corretto funzionamento del servizio, ad esempio quando qualcuno segnala un link utilizzando l’apposita funzione oppure per diagnosticare problemi. Effettueremo analisi delle schermate in modo aggregato per migliorare Paga Shot, ad esempio per identificare la dimensione media e il numero di schermate salvate.</li> <li>Raccogliamo dati per analizzare l’interazione con il prodotto, come il numero di click sul pulsante per catturare o salvare la schermata, o se viene riscontrato un errore durante il salvataggio.</li> <li>Per prevenire abusi del servizio teniamo sotto controllo la situazione periodicamente. Ad esempio, manteniamo una lista di indirizzi IP per individuare e bloccare soggetti che effettuano una scansione del servizio per trovare pagina private.</li> <li>Per tutte le visite al sito web di Page Shot, raccogliamo dati come descritto nella nostra <a href="https://www.mozilla.org/privacy/websites/" target="_blank">Informativa sulla privacy dei siti web, comunicazioni e cookie</a>.</li></ul>
