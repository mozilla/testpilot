...
footerLinkFeedback = Enviar comentarios
...
landingUpgradeDesc2 = Test Pilot requiere { $version } de Firefox o más superior.
# also in footer
...
landingCardTwo = Habilitar características experimentales
landingCardThree = Dinos lo que piensas

## Shown after the user installs the Test Pilot add-on.

onboardingMessage = Hemos puesto un ícono en la barra de herramientas para que accedas fácilmente a Test Pilot.

## Error message pages.

errorHeading = ¡Ups!
errorMessage = Parece que algo está mal. <br> Vuelve a intentarlo luego.
...
experimentListHeaderWithFeatured = Probar todos los experimentos
...
wrongPlatformIOS = Este experimento está disponible para dispositivos iOS solamente.
wrongPlatformAndroid = Este experimento está disponible para dispositivos Android solamente.
...
retireMessageUpdate = Como desees. Esto desinstalará Test ílot. Puedes desactivar los experimentos individuales del Administrador de Complementos de Firefox.
...
warningGoToFAQDetail = Algo ha pasado con Test Pilot. Por favor, <a>revisa las preguntas frecuentes</a> para saber más.
