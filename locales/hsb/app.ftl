...
experimentCondensedHeader = Witajće k Test Pilot!
experimentListHeader = Wubjerće swoje eksperimenty!
...
experimentManuallyDisabled = { $title } w zrjadowaku přidatkow znjemóžnjeny
experimentMeasurementIntro = Nimo <a>datow</a>, kotrež su so přez wšě eksperimenty Test Pilot zhromadźili, je wažnje, zo slědowace wo tym wědźeć, štož so stawa, hdyž { $experimentTitle } wužiwaće:
...
experimentGradReportButton = Kónčna rozprawa
...
learnMoreLink = DALŠE INFORMACIJE
...
versionChangeNotice = { $experiment_title } so w tutej wersiji Firefox njepodpěruje.
versionChangeNoticeLink = Wobstarajće sej aktualnu wersiju Firefox.
...
newsletterFormEmailPlaceholder
    .placeholder = Wašu e-mejlowu adresu tu zapisać
...
newsletterFormPrivacyAgreementRequired = Prošu stajće hóčku do tutoho kašćika, jeli chceće pokročować.
...
localeNotTranslatedWarningTitle = Tutón eksperiment njeje so do wašeje rěče ({ $locale_code }) přełožił.
