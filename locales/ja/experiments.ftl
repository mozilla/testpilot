...
containersWarning = 注: コンテナーのセキュリティ特性が原因で、Page Shot、Snooze Tabs、Pulse、Activity Stream などの Test Pilot 実験はコンテナータブ内では動作しない可能性があります。これは実験的な技術であることを覚えておいてください！
...
containersToursteps1Copy = 新しいタブボタンにマウスオーバーして、コンテナーを選びましょう。
