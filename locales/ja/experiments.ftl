...
activitystreamEolwarning = この実験は終了しましたが、Activity Stream はこの秋に Firefox 本体へ組み込まれます。既に Activity Stream をお使いの場合は自動的に移行されます。
cliqzDescription = 検索結果をもっと素早く手に入れよう。Cliqz は、アドレスバーへ検索語句を入力中、そのすぐ下に候補一覧を表示します。その際プライバシーは保たれます。
cliqzIntroduction = ブラウザー内で直接、検索結果をもっと素早く手に入れましょう。検索語句を入力し始めると同時に、アドレスバーの直下にウェブ検索候補がリアルタイムで表示されます。Cliqz は個人を識別可能なデータの収集やユーザープロフィールの作成を行わないため、プライバシーを保ちつつ結果を得ることができます。
...
containersIntroduction = Containers を使えば、あなたのあらゆるオンライン生活のためのプロフィールを Firefox 内に複数作成できます。任意のラベルと色分けされたタブで、オンラインショッピング、旅行の計画、仕事メールのチェックなど、異なる活動を別々に分けておくことが可能です。Containers では個別に Cookie が保存されるため、コンテナーごとに違うアカウントで同じサイトへログインすることができ、オンラインの追跡者はあるコンテナー内でのあなたのブラウジング活動を他のコンテナーと結び付けられなくなります。そのため、ウェブ上で追い回される心配をせずに、ショッピング用、ソーシャル用、仕事用など、別々のプロフィールを保てます。
...
containersToursteps0Copy = コンテナーを立ち上げて、一連のタブにラベルを付けて整理しましょう。
...
nomore404sEolwarning = No More 404s 実験は終了時にお使いのブラウザから削除されず、その後この場で私たちから結果を報告します。更新は将来的に addons.mozilla.org で提供されます。
...
pageshotEolwarning = この実験は終了しましたが、Page Shot はこの秋に Firefox 本体へ組み込まれます。既に Page Shot をお使いの場合は自動的に移行されます。
...
pulsePrefeedbackcopy = <p>Firefox でうまく動かないサイトを報告するには、サイトの URL が表示されているアドレスバー内の Pulse アイコンを選択してください。</p>
...
pulseToursteps0Copy = アドレスバー内の Pulse アイコンをクリックして、そのウェブサイトに関するフィードバックを送ってください。
...
tabcenterEolwarning = Tab Center 実験は終了します。この秋には自動的に削除されます。
trackingprotectionDescription = トラッキング保護機能の改善に協力いただけますか？ この実験はすべてのページでトラッキング保護機能を有効化し、ブラウジング中に何か問題に遭遇した場合は簡単に報告できる方法を提供します。
trackingprotectionIntroduction = <p>これまで、Firefox のトラッキング保護機能はプライベートブラウジングモードのみで使用可能でした。この実験はトラッキング保護機能を常時有効化します。(もちろん、必要に応じてサイトごとに無効化することもできます)</p><p>この実験では、トラッキング保護機能によってウェブ上のどこがうまく動かなくなるか私たちが理解を深めるための手助けを皆さんにしてもらい、すべての Firefox ユーザーのためにこの機能を改善することを目的としています。ブラウジング中に、アドレスバー内の紫色の盾アイコンをクリックして、トラッキング保護機能が問題なく動作するサイトとそうでないサイトを報告してください。</p>
...
trackingprotectionPrefeedbackcopy = <p>トラッキング保護機能有効時にうまく動かないサイトを報告するには、そのサイトの URL を表示しているアドレスバー内の盾アイコンを選択してください。</p>
...
trackingprotectionContributorsextra = この実験は、Mozilla のスタッフと貢献者により過去数年にわたって開発されてきた Firefox のトラッキング保護機能をもとにしています。
...
universalsearchMeasurements0 = Mozilla は、入力された文字の数、あなたがクリックした結果の種類、その結果リスト内の位置など、あなたとアドレスバーのインタラクションに関する基本的な使用状況データを収集します。
universalsearchMeasurements1 = あなたが検索バー内に検索候補を表示するよう過去に Firefox を設定していた場合、Universal Search をインストールすると、アドレスバー内での <a href="https://www.mozilla.org/privacy/firefox/#searchsuggestions" target="_blank">検索候補表示</a> も有効となります。
universalsearchMeasurements2 = アドレスバーを使用する際、あなたが入力した語句がリコメンデーションエンジンへ送信されます。Mozilla は、リコメンデーションの品質を向上させるため、よく使用される検索語句について匿名のログを保存します。
universalsearchMeasurements3 = Universal Search を提供するため、いくつかのサードパーティーサービスを使用します。リコメンデーションを提供するために <a href="http://www.bing.com/developers/s/APIBasics.html" target="_blank">Bing</a> と <a href="https://developer.yahoo.com/boss/search/" target="_blank">Yahoo</a> を、またそれらのリコメンデーションに関する追加情報 (画像やアイコンなど) を提供するために <a href="http://docs.embed.ly/docs/" target="_blank">Embedly</a> と <a href="https://clearbit.com/logo" target="_blank">Clearbit</a> を使用します。アドレスバー内にリコメンデーションを表示するため、Universal Search はそれらの画像を直接 Embedly と Clearbit からダウンロードする場合があり、それによってそれらのサービスがあなたの IP アドレスとリクエストされた画像を把握できるようになる可能性があります。
...
testpilotNewsupdatesGeneralupdate4Title = Page Shot は Firefox Screenshots になりました
testpilotNewsupdatesGeneralupdate4Content = Page Shot 実験は Firefox Screenshots として Firefox に組み込まれました。その経緯を説明します。
sendNewsupdatesSendupdate1Title = Send が Safari や Edge にも対応！
sendNewsupdatesSendupdate1Content = 対応ブラウザーの拡大、その他いくつかの改良を行った Send 1.1.0 を公開しました。
sendNewsupdatesSendupdate2Title = Send から得られた知見
sendNewsupdatesSendupdate2Content = Send のユーザーインターフェイスについて理解を深めるため、初の A/B テストを実施しました。その結果を紹介します。
