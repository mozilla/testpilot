...
voicefillMeasurements0 = Voice Fill を使うことを選択した場合、あなたの録音は私たちのサーバーへ送信され、推定された文字列をあなたへ返すために処理されます。
voicefillMeasurements1 = Voice Fill は機能のパフォーマンスに関連した技術情報を収集します。これには、サーバーが送信された録音を処理するのに掛かった時間や、返された推定文字列をあなたが選択あるいは変更したかどうかなどが含まれます。
