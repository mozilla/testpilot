...
cliqzDetails1Copy = 天気など、リアルタイムの要約情報が、ロケーションバーの直下に表示されます。
...
minvidMeasurements0 = 私たちは、あなたがいつコンテキストメニュー、実験アイコン、プレーヤーコントロールを操作しているかに関する使用状況データを収集します。
...
nomore404sMeasurements2 = 私たちはあなたがリクエストしたページの URL や、私たちが Archive.org へ送信した URL は収集しません。
...
notesIntroduction = Notes はブラウザーのサイドバーにシンプルな 1 ページメモ帳を追加します。まずはいくつかの基本的な書式設定を用意しましたが、どんな機能が欲しいかフィードバックをお待ちしています。
...
pageshotMeasurements0 = 私たちはあなたのスクリーンショットを Mozilla のサーバー上に保存しており、それらのショットにアクセスすることが可能です。しかし私たちは、誰かが「フラグ」機能を使ってショットへのリンクを送ってきた場合や、何らかの問題が発生した場合の原因特定など、このサービスの運営にとって合理的に必要な場合に限ってあなたのショットにアクセスします。また、すべてのショットを集合的に解析し、例えばユーザーによって撮影されたショットの平均サイズや数などを特定することによって、Page Shot の改善に役立てます。
pageshotMeasurements1 = 私たちは、あなたがショットボタンをクリックしたり、画像を保存したり、画像保存時にエラーに遭遇したりした回数など、あなたと製品のインタラクションの理解を深めるため、使用状況データを収集します。
pageshotMeasurements2 = このサービスの不正利用を防ぐため、私たちは基本的なセキュリティ監視を行います。例えば、個人的なページを見つけるためにサービスをスキャンしている個人を判別しブロックするため、IP アドレスを収集、保存します。
...
sendMeasurements0 = Send を使用すると、Mozilla はあなたがアップロードしたファイルの暗号化されたコピーを、ファイル名やファイルサイズといったそのファイルに関する基本情報とともに受け取ります。Mozilla は暗号化されたファイルの内容にアクセスできず、明記された時間やダウンロード回数までに限りそれを保存します。
sendMeasurements1 = あなたが以前アップロードしたファイルの状況を確認したり、それらを削除したりできるよう、アップロードされたファイルの基本情報がお使いのローカル端末上に保存されます。これには、Send のファイル識別子、ファイル名、ファイルの固有ダウンロードリンクが含まれます。これらの情報は、あなたがアップロードしたファイルを削除するか、ファイルの期限後に Send を訪れた際に消去されます。
sendMeasurements2 = あなたの暗号化されたファイルへの固有リンク (暗号化キーを含む) を受け取った人は誰でもそのファイルをダウンロードし開くことができます。あなたの暗号化されたファイルへのアクセスを望まない人にリンクを送ってはいけません。
sendMeasurements3 = Send は、パフォーマンスやあなたのサービス利用状況に関する情報も収集します。これには、ファイルのアップロード頻度、期限切れ前に Mozilla のサーバーにファイルが保存された時間、ファイル転送に関する何らかのエラー、お使いのブラウザが対応している暗号化プロトコルが含まれます。
sendMeasurements4 = Send には Mozilla の <a href="https://www.mozilla.org/privacy/websites/" target="_blank">ウェブサイトプライバシー通知</a> も適用されます。あなたが Send のウェブサイトを訪れる際、あなたの IP アドレスなどの情報が標準的なサーバーログの一部として一時的に記録されます。
sendDetails0Copy = Send では、暗号化されたファイルをアップロード、共有できます。
...
voicefillIntroduction = <p>Voice Fill は人工知能 (AI) を活用して音声入力を解析します。Voice Fill 実験の参加者として、あなたの音声検索が、より賢い結果を返せるように AI を鍛えます。</p> <p>私たちは Voice Fill を Google、Yahoo、DuckDuckGo の検索ページへ追加しました。実験が進むにつれて、さらに多くのサイトへ展開していく予定です。</p>
...
voicefillMeasurements3 = 推定精度を高めるため、私たちは送信された録音のコピーと関連する推定情報を保存する場合があります。この目的のために保存された録音が個人を識別できる他の何らかの情報と関連付けられることはありません。
voicefillDetails0Copy = Yahoo、DuckDuckGo、Google 上でマイクのアイコンを探してください。
voicefillDetails1Copy = Voice Fill を使う前に、音声入力を許可する必要があります。
voicefillDetails2Copy = Voice Fill は複数の推定結果を提示する場合があります。AI の訓練に協力したい場合はいずれかを選択してください。
voicefillToursteps0Copy = Yahoo、DuckDuckGo、Google を使う際に Voice Fill アイコンを探してください。
