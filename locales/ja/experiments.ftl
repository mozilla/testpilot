...
cliqzEolwarning = この実験はまもなく終了します。これを有効にしているユーザーは、当面そのままにしておくことは可能です。また、新バージョンが公開された際には移行措置を提供します。
...
minvidEolwarning = Min Vid は近く Test Pilot を離れますが、残念ながら全ユーザーに無効化の対応を行うことになります。
...
snoozetabsEolwarning = Snooze Tabs は近くすべての Firefox ユーザー向けにアドオンとして提供されます。この実験をインストールしていたユーザーは自動的に更新されます。
