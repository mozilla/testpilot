...
landingLegalNoticeWithLinks = Al continuar, aceptás los <terms-link>términos de uso</terms-link> y la <privacy-link>nota de privacidad</privacy-link> de Test Pilot.
...
startedDate = Fecha de inicio del experimento: <b>{ $completedDate }</b>
...
versionChangeNoticeLink = Obtener la versión actual de Firefox.

## Shown while uninstalling Test Pilot.

retireDialogTitle = ¿Desinstalar Test Pilot?
retireMessageUpdate = Como quiera. Esto desinstalará Test Pilot. Puede deshabilitar los experimentos individuales desde el Administrador de complementos de Firefox.
...
eolTitleMessage = { $title } está terminando el { DATETIME($completedDate) }
...
completedDate = Fecha de finalización del experimento: <b>{ DATETIME($completedDate) }</b>
...
newsletterFormEmailPlaceholder =
    .placeholder = Tu correo electrónico acá
...
warningGoToFAQDetail = Algo salió mal en Test Pilot. Por favor, <a>revise las preguntas frecuentes</a> para conocer más.
...
jsDisabledWarning = Test Pilot requiere JavaScript. Disculpe
