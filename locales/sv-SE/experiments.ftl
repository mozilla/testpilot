...
sendMeasurements3 = Send är också föremål för vår <a href="https://www.mozilla.org/privacy/websites/" target="_blank">sekretesspolicy för webbplatser</a>. När du besöker webbplatsen Send, sparas information som din IP-adress temporärt som en del av en vanlig serverlogg.
sendMeasurements4 = Send kommer också samla in information om prestanda och användningen av tjänsten, till exempel hur ofta du laddar upp filer, hur länge dina filer är kvar hos Mozilla innan de upphör att gälla, eventuella fel relaterade till filöverföringar och vilka krypteringsprotokoll som din webbläsare stöder.
