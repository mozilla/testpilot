...
containersToursteps1CopyLongpress = Långt tryck på knappen Ny flik för att välja en behållare.
...
notesToursteps1Copy = Vi har byggt några grundläggande formateringsalternativ i Notes. Med din återkoppling lägger vi till fler funktioner.
notesToursteps2Copy = Du kan komma tillbaka till experimentet Notes genom att klicka på sidofältsikonen.
notesToursteps3Copy = Du kan alltid ge oss återkoppling eller inaktivera Notes från Test Pilot.
...
sendMeasurementsFilehash0 = När du använder Send, Så får Mozilla en krypterad kopia på filen du laddar upp, och grundläggande information om din fil, tex filnamn, fil hash, fil storlek. Mozilla har inte verktygen för att få ut någon information från din krypterade fil. och sparar den endast en viss tid eller tills den har laddats ner ett visst antal gånger.
sendMeasurementsFilehash1 = För att du ska kunna visa status för dina tidigare uppladdade filer eller radera dem, lagras grundläggande information om dina uppladdade filer på din lokala enhet, t.ex. Sends identifierare för filen, filnamnet och filens unika nedladdningslänk. Detta rensas om du raderar din uppladdade fil eller när du besöker Send efter att filen har upphört.
...
testpilotNewsupdatesGeneralupdate3Title = Nya experiment lanserat
testpilotNewsupdatesGeneralupdate3Content = Introducerar Send, Notes och Voice Fill. Klicka på korten nedan för att prova dem.
testpilotNewsupdatesGeneralupdate4Title = Vi startade en blogg
testpilotNewsupdatesGeneralupdate4Content = Kolla in vår helt nya blogg för en fördjupande diskussion om Firefox Test Pilot.
