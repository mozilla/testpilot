...
testpilotNewsupdatesGeneralupdate4Content = Experimentet Page Shot kommer nu med i Firefox som Firefox Screenshots. Ta reda på hur det hände.
...
sendNewsupdatesSendupdate2Title = Lär dig från Send
sendNewsupdatesSendupdate2Content = Vi har just genomfört vårt första A/B-test för att lära oss mer om Send:s användargränssnitt. Se resultaten.
