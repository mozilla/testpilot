...
sendMeasurements0 = När du använder Send får Mozilla en krypterad kopia av filen du laddat upp och grundläggande information om filen, till exempel filnamn och filstorlek. Mozilla har inte möjlighet att komma åt innehållet i din krypterade fil och behåller den bara för tiden eller det antal nedladdningar som anges.
