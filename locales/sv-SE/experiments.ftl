...
testpilotNewsupdatesGeneralupdate6Title = Test Pilot designkurs för tillgänglighet 
testpilotNewsupdatesGeneralupdate6Content = Test Pilot samarbetade nyligen med designstudenter på Ravensbourne för att utforska tillgänglighetsutmaningar på webben.
testpilotNewsupdatesGeneralupdate5Title = Utveckla Test Pilot med Storybooks
testpilotNewsupdatesGeneralupdate5Content = Test Pilot använder nu Storybooks visualiseringsverktyg för att underlätta utveckling av användargränssnittet. Kolla in detta dokument för att lära dig mer.
...
activitystreamNewsupdatesAsupdate1Title = Slutrapport för Activity Stream
activitystreamNewsupdatesAsupdate1Content = Activity Stream gjorde hoppet från Test Pilot till Firefox. Ta reda på hur det hände.
containersNewsupdatesContainersupdate1Title = Slutrapport för Containers
containersNewsupdatesContainersupdate1Content = Containers gjorde hoppet från Test Pilot och är nu tillgängliga som ett tillägg för alla Firefox-användare.
notesNewsupdatesNotesupdate2Title = Synkronisera dina anteckningar
notesNewsupdatesNotesupdate2Content = Från och med idag kan du nu synkronisera dina anteckningar varhelst du använder Firefox. Se hur vi gjorde det.
notesNewsupdatesNotesupdate1Title = Förbättringar i Notes
notesNewsupdatesNotesupdate1Content = Vi förbättrade dramatiskt Notes genom att byta textredigerare.
