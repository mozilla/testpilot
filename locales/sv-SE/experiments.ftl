...
cliqzDetails0Copy = Visa när resultat dyker upp (som magi!) när du skriver din sökning i URL fältet.
cliqzDetails2Copy = Gå tillbaka till dina favoritsidor i ett klick när du öppnar en ny flik. Du kan även anpassa dina favoriter.
cliqzToursteps0Copy = <p>Börja med att skriva i URL fältet för att se realtids resultat.</p>
cliqzToursteps1Copy = <p>Öppna en ny flik och lägg till dina favorit hemsidor för snabb åtkomst med ett musklick.</p>
