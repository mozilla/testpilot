...
sendMeasurements1 = För att du ska kunna visa status för dina tidigare uppladdade filer eller radera dem, lagras grundläggande information om dina uppladdade filer på din lokala enhet, t.ex. Sends identifierare för filen, filnamnet och filens unika nedladdningslänk. Detta rensas om du raderar din uppladdade fil eller när du besöker Send efter att filen har upphört.
sendMeasurements2 = Alla som du ger den unika länken (inklusive krypteringsnyckeln) till din krypterade fil kommer att kunna hämta och komma åt den filen. Du bör inte ge länken till någon som du inte vill ska ha tillgång till din krypterade fil.
sendMeasurements3 = Send kommer också samla in information om prestanda och användningen av tjänsten, till exempel hur ofta du laddar upp filer, hur länge dina filer är kvar hos Mozilla innan de upphör att gälla, eventuella fel relaterade till filöverföringar och vilka krypteringsprotokoll som din webbläsare stöder.
sendMeasurements4 = Send är också föremål för vår <a href="https://www.mozilla.org/privacy/websites/" target="_blank">sekretesspolicy för webbplatser</a>. När du besöker webbplatsen Send, sparas information som din IP-adress temporärt som en del av en vanlig serverlogg.
