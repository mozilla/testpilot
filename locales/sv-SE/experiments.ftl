...
pageshotDetails1Copy = Dela länkar till bilder via social media eller epost , utan att behöva ladda ner eller bifoga en fil.
...
pageshotToursteps3Copy = <p>Sök eller bläddra för att hitta spara skärmskott.</p>
...
tabcenterDetails2Copy = Möblera om och flytta möblerna! Tab Center arbetar med dina favorit Firefox teman.
...
trackingprotectionToursteps2Copy = <p>Du kan alltid slå av Firefox spårningsskydd från Test Pilot.</p>
...
trackingprotectionContributorsextra = Detta experiment bygger på Firefox spårningsskydd teknik som byggts av Mozilla anställda och medarbetare över flera år.
