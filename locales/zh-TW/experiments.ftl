...
trackingprotectionToursteps2Copy = <p>您可以隨時在 Test Pilot 停用 Tracking Protection。</p>
...
universalsearchToursteps2Copy = <p>您可隨時從 Test Pilot 提供意見回饋，或停用 Universal Search。</p>
