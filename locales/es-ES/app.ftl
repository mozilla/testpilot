...
landingFxaGetStartedButton = Empieza con una cuenta de Firefox
landingLegalNotice = Al continuar, aceptas los <a>Términos de uso</a> y el <a>Aviso sobre privacidad</a> de Test Pilot.
landingInstallHeader = ¡Obtén el complemento para seguir!
...
discourse = Discourse
nowActive = Activo
userCount = [html/title] Usuarios activos de este experimento
tourOnboardingTitle = ¡{ $title } activado!
tourStartButton = Visita virtual
