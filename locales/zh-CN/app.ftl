...
landingRequiresDesktop = Test Pilot 需要运行在 Windows、Mac 或 Linux 计算机上的 Firefox 桌面版
...
experimentPromoSubheader = 我们正在为下一代的 Firefox 打造新功能。安装 Test Pilot 尝试它们！
