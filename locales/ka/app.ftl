...
mobileDialogNoticeSMS = SMS მომსახურება, მხოლოდ მითითებულ ქვეყნებშია ხელმისაწვდომი. შეიძლება ჩამოგეჭრათ SMS და მობილური ინტერნეტის საფასური, ანგარიშიდან. ელფოსტის ან SMS-ის მიმღების თანხმობა აუცილებელია. { $learnMore }
