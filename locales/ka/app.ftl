...
landingRequiresDesktop = Test Pilot-ის გამოსაყენებლად საჭიროა Firefox-ის სამაგიდო ვერსია Windows, Mac, ან Linux სისტემაზე.
...
mobileDialogNoticeSMSWithLink = SMS-მომსახურება, მხოლოდ მითითებულ ქვეყნებშია ხელმისაწვდომი. შეიძლება ჩამოგეჭრათ SMS და მობილური ინტერნეტის საფასური, ანგარიშიდან. ელფოსტის ან SMS-ის მიმღების თანხმობა აუცილებელია. <a>იხილეთ ვრცლად</a>.
...
disableExperiment = { $title } გამორთვა
disableExperimentTransition = გამოირთვება...
enableExperiment = { $title } ჩართვა
...
warningGoToFAQDetail = რაღაც ხარვეზი წარმოიქმნა Test Pilot-თან დაკავშირებით. გთხოვთ, <a>გაეცნოთ ხ.დ.კ. გვერდს</a> დამატებითი ინფორმაციისთვის.
warningUpgradeFirefoxTitle = გასაგრძელებლად, განაახლეთ Firefox!
warningUpgradeFirefoxDetail = Test Pilot საჭიროებს Firefox-ის უახლეს ვერსიას. <a>განაახლეთ Firefox</a> დასაწყებად.
warningHttpsRequiredTitle = აუცილებელია HTTPS!
warningHttpsRequiredDetail = Test Pilot წვდომისთვის საჭიროებს HTTPS-ოქმს. დამატებითი ინფორმაციისთვის, გთხოვთ გაეცნოთ <a>ჩვენს მასალებს</a>.
