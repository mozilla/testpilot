...
experimentManuallyDisabled = { $title } letiltva a Kiegészítőkezelőben
...
newsletterFormEmailPlaceholder =
    .placeholder = Itt adja meg az e-mail címét
