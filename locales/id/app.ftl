...
experimentListJustLaunchedTab = Baru Diluncurkan
...
tour = Tur
tourLink = Jalankan Tur
contribute = Kontribusi
bugReports = Laporan Bug
discussExperiment = Diskusi { $title }
tourOnboardingTitle = { $title } diaktifkan!
...
retirePageHeadline = Terima kasih telah terbang!
retirePageMessage = Kami harap Anda senang mencoba percobaan kami. <br> Datang kembali kapan saja.
...
restartIntroOne = Mulai ulang peramban Anda
restartIntroTwo = Temukan pengaya Test Pilot
