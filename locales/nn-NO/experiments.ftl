...
sendMeasurements1 = For at du skal kunna sjå status for dei tidlegare opplasta filene dine eller slette dei, vert det lagra grunnleggjande informasjon om dei opplasta filene dine på den lokale eininga di, t.d. Send sin identifikator for fila, filnamnet og fila si unike nedladdningslenke. Dette vert fjerna om du slettar den opplasta fila di, eller når du vitjar Send etter at fila har gått ut.
sendMeasurements2 = Alle som du gjev den unike lenka (inkludert kryptringnøkkelen) til den krypterte fila di vil kunne laste ned og ha tilgang til den fila. Du bør ikkje gje lenka til nokon som du ikkje vil skal ha tilgang til den krypterte fila di.
sendMeasurements3 = Send er òg underlagt <a href="https://www.mozilla.org/privacy/websites/" target="_blank">personvernpraksisen vår for nettstadar</a>. Når du vitjar nettstaden Send, vert informasjon, slik som IP-adressa di, mellombels behalde som ein del av ein vanleg tenarlogg.
sendMeasurements4 = Send vil også samle inn informasjon om yting og bruken din av tenesta, til dømes kor ofte du lastar opp filer, kor lenge filene dine blir verande hos Mozilla før dei går ut, eventuelle feil relaterte til filoverføringar og kva for krypteringprotokoll nettlesaren din støttar.
