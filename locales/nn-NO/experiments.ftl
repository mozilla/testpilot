...
activitystreamEolwarning = Dette eksperimentet vert snart avslutta, men Activity Stream kjem til å bli levert i Firefox som standard denne hausten. Hald utkik i komande versjonar av Firefox!
...
containersToursteps1CopyLongpress = Langt trykk på knappen Ny fane for å velje ein behaldar.
...
containersToursteps3CopyRewordwithouttoolbar = Du kan gøyme alle opne faner i ein Container for å halde nettlesaren din ryddig.
...
notesDescription = Ein enkel «enkel tekst» innebygd i Firefox. Har du nokongong hatt behov for å krote ned noko medan du surfar på nettet? Dette er eksperimentet for deg
notesIntroduction = Notes legg til ei enkel skriveblokk på ei side i sidestolpen til nettlesaren. Vi har lagt til nokre grunnleggjande formateringsalternativ til å byrje med, men vi vil ha ei tilbakemelding frå deg som fortel oss kva for funksjonar du vil at vi skal ta med.
...
notesMeasurements1 = Notes kjem òg å samle inn informasjon om interaksjonen din med tillegget, til dømes korleis du opnar funksjonen og kva for knappar du kanskje klikkar på.
notesDetails0Copy = Det er ei skriveblokk. Korfor tenkte vi ikkje på det tidlegare?
notesToursteps0Copy = Notes legg til ei enkel skriveblokk i sidestolpen til nettlesaren.
notesToursteps1Copy = Vi har bygd inn nokre grunnleggjande formateringsalternativ i Notes. Med tilbakemelding frå deg, legg vi til fleire funksjonar.
notesToursteps2Copy = Du kan kome attende til eksperimentet Notes ved å å klikke på sidestolpeikonet.
notesToursteps3Copy = Du kan alltid gje oss ei tilbakemelding eller slå av Notes frå Test Pilot.
...
pageshotEolwarning = Page Shot kjem til Firefox 55 som Firefox Screenshots. Om du allereie nyttar Page Sho, vil vi automatisk oppgradere deg.
...
tabcenterEolwarning = Eksperimentet Tab Center vert snart slutta. Det kjem automatisk til å verta inaktivert denne hausten.
...
voicefillToursteps0Copy = Sjå etter ikonet Voice Fill når du nyttar Google, Yahoo eller DuckDuckGo.
...
testpilotNewsupdatesGeneralupdate4Title = Page Shot er no Firefox Screenshots
testpilotNewsupdatesGeneralupdate4Content = Eksperimentet Page Shot kjem no med i Firefox som Firefox Screenshots. Finn ut korleis det skjedde.
sendNewsupdatesSendupdate1Title = Send med Safari og Edge!
sendNewsupdatesSendupdate1Content = Send 1.1.0 er nettopp sendt ut med forbetra nettlesarstøtte, i tillegg til ein del andre forbetringar.
sendNewsupdatesSendupdate2Title = Lær deg frå Send
sendNewsupdatesSendupdate2Content = Vi har nettopp gjennomført den første A/B-testen vår for å lære oss meir om brukargrensesnittet i Send. Sjå resultatet.
