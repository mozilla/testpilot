...
activitystreamEolwarning = Dette eksperimentet vert snart avslutta, men Activity Stream vil framleis bli levert i Firefox som standard. Hald utkik i komande versjonar av Firefox!
...
testpilotNewsupdatesGeneralupdate3Title = Nye eksperiment lansert
testpilotNewsupdatesGeneralupdate3Content = Introduserer Send, Notes og Voice Fill. Klikk på korta nedanfor for å prøve dei.
testpilotNewsupdatesGeneralupdate4Title = Vi starta ein blogg
testpilotNewsupdatesGeneralupdate4Content = Sjekk ut den splitter nye bloggen vår for ein fordjupande diskusjon om Firefox Test Pilot.
