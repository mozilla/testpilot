...
notesToursteps1Copy = Vi har bygd inn nokre grunnleggjande formateringsalternativ i Notes. Med di tilbakemelding, legg vi til fleire funksjonar.
notesToursteps2Copy = Du kan koma attende til eksperimentet Notes ved å å klikke på sidestolpeikonet.
...
sendMeasurements0 = Når du brukar Send får Mozilla ein kryptert kopi av fila du lasta opp og grunnleggjande informasjon om fila, til dømes filnamn og filstorleik. Mozilla har ikkje tilgang til innhaldet i den krypterte fila di, og beheld henne berre i den tida eller tal på nedlastingar som er spesifisert.
