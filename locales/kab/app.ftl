...
footerLinkAboutHeader = Ɣef
footerLinkAboutUs = Fell-aɣ
footerLinkSupportHeader = Tallelt
footerLinkDownload = Sider Firefox
# link to page detailing firefox mobile browser options
footerLinkMobile = Aziraz
footerLinkFeatures = Timahilin
footerLinkBeta = Beta, Nightly, Developer Edition
footerLinkRetire = Kkes Test Pilot
...
landingUpgradeDesc2 = Test Pilot yesra Firefox { $version } neγ ugar.
# also in footer
...
mobileDialogNoticeSMSWithLink = Ameẓlu SMS yella kan di kra n tmura yettwafernen. Tasqamt n SMS & yisefka ad yettwasnes. Aɣerwaḍ  n yimayl neɣ SMS yessefk ad yeqbel. <a>Issin ugar</a>.
...
experimentListHeaderWithFeatured = Ɛreḍ akk tirmitin-nneɣ
...
wrongPlatformIOS = Tarmit-agi tella kan i yibenkan iOS.
wrongPlatformAndroid = Tarmit-agi tella kan i yibenkan Android.
otherExperiments = Ɛreḍ ula d tirmitin-agi nniḍen.
giveFeedback = Mudd-d tikti
disableHeader = Kkes armed i urmitan?
disableExperiment = Sens { $title }
...
retireMessageUpdate = Akken tebɣiḍ. Tigawt-a ad tekkes Test Pilot. Ad tizmired ad tekkseḍ akk tirmitin yiwet yiwet seg umsefrak n yizegrar n Firefox.
...
localeNotTranslatedWarningTitle = Tarmit-agi ur tettwasuqel ara ar tutlayt-ik ({ $locale_code }).
...
jsDisabledWarning = Test Pilot yesra JavaScript. Suref-aɣ.

## eol strings

-brand = Firefox
-product = Firefox Test Pilot
-exp-containers = Imagbaren
