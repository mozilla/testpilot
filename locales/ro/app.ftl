...
onboardingMessage = Am adăugat o pictogramă în bara de unelte ca să poți găsi mereu Test Pilot.
...
# the number 0.
notFoundHeader = Patru zero patru!
...
experimentListEnabledTab = Activat
experimentListJustLaunchedTab = Tocmai lansat
...
newsletterFormPrivacyNotice = Sunt de acord ca Mozilla să îmi prelucreze informațiile, conform explicațiilor din <a>această Politică de confidențialitate</a>.
